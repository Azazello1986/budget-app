...
Role = Enum("viewer", "editor", name="role_enum")
Granularity = Enum("day", "week", "month", "year", name="granularity_enum")
Kind = Enum("planned", "actual", name="kind_enum")
Sign = Enum("income", "expense", "transfer", name="sign_enum")
